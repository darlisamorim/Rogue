...
<template>
    <GuestLayout>
        ...
        <div class="mb-4 text-sm text-gray-600">
            Obrigado por se cadastrar! Antes de começar, verifique seu endereço de e-mail clicando no link que acabamos de enviar. Se não recebeu o e-mail, podemos reenviar outro.
        </div>
