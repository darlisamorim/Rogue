...
function goToCheckout(resumeId: number, type: string) {
    router.get(route('payment.checkout'), { resume_id: resumeId, type })
}
                    ...
                    >
                        ...
                        <div class="p-4">
                            ...
                            <div class="flex flex-col gap-2 mt-4">
                                ...
                                <!-- Se já pagou: botão de download direto -->
                                <template v-if="resume.is_downloaded">
                                    <Link
                                        :href="route('resumes.show', resume.id)"
                                        class="w-full flex items-center justify-center gap-1.5 py-2 px-3 bg-emerald-600 text-white text-xs font-semibold rounded-lg hover:bg-emerald-700 transition-colors"
                                    >
                                        <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <!-- Se ainda não pagou: vai para checkout -->
                                <template v-else>
                                    <button
                                        type="button"
                                        @click="goToCheckout(resume.id, 'first_download')"
                                        class="w-full flex items-center justify-center gap-1.5 py-2 px-3 bg-blue-600 text-white text-xs font-semibold rounded-lg hover:bg-blue-700 transition-colors"
                                    >
                                        <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-4l-4 4m0 0l-4-4m4 4V4" />
                                        </svg>
